...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[picnode] (A) {\includegraphics{1.5_figures/test figures/dtb3.pdf}};
        \node[right=of A, picnode] (B) {\includegraphics{1.5_figures/test figures/dtwexbgs.pdf}};
        \node[below=of A, picnode] (C) {\includegraphics{1.5_figures/test figures/vixcls.pdf}};
        \node[right=of C, picnode] (D) {\includegraphics{1.5_figures/test figures/gsci.pdf}};
